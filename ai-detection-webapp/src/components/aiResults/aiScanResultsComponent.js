...
export const AIScanResult = (response, isUrl) => {
    ...
    const isGeneratedByAi = response.response.aiScore > 0.5;

    const positiveScan = 'We believe that this content was generated by AI';
    const negativeScan = 'We believe that this content was NOT generated by AI';
  return (
